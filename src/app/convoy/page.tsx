...
export default function ConvoyDetails() {
    return <main className={styles.main}>
        <article>
            <p>
                <a href='https://realsgii2.dev' target={'_blank'} className={styles.realsgHeader}>RealSGII2/</a>
            </p>
            ...
            <div className={styles.errorCallout}>
                <p>
                    <b>Required mods were removed.</b>
                </p>
                <p>Check the update notes above for changes.</p>
            </div>

            <h2>Download Mods</h2>
            <p>First, subscribe to the steam collection:</p>
            <a
                href='https://steamcommunity.com/sharedfiles/filedetails/?id=3577280676'
                rel={'noreferrer'}
                target={'_blank'}
            ...
            <details>
                <summary>View optional mods</summary>

                <a
                    href='https://steamcommunity.com/sharedfiles/filedetails/?id=3596006846'
                    target={'_blank'}
                    className={styles.modItem}
                >
                    <span>XTX MIRRORS FOV V1.0</span>
                    <span>Makes your truck&apos;s mirrors have an accurate FOV.</span>
                </a>

                <a
                    href='https://steamcommunity.com/sharedfiles/filedetails/?id=3370862855'
                    target={'_blank'}
                    className={styles.modItem}
                >
                    <span>Realistic Weather System ATS</span>
                    <span>Changes the weather system to mimic real life areas and makes the intensity range much larger.<br /><i>Recommended to use with &quot;Better Raindrops&quot;!</i></span>
                </a>

                <a
                    href='https://steamcommunity.com/sharedfiles/filedetails/?id=2980935675'
                    target={'_blank'}
                    className={styles.modItem}
                >
                    <span>Better Raindrops</span>
            ...
            <h2>Mod Order</h2>
            <p>Make sure these mods are in the order listed below. If you want to include your own mods, put them above
                or below this list. These mods <b>must</b> be next to each other in this order.
            </p>
            ...
            <ul>
                ...
                <li>We have a thread in corp-random called <strong>Commercial Vehicle Fan Club</strong>, come join us!
                </li>
            </ul>

            <p className={styles.copyright}>&copy; {new Date().getFullYear()} &mdash; Website built and server
                maintained by <a
                    className={styles.alink} href='https://realsgii2.dev/' target={'_blank'} rel={'noreferrer'}
                >RealSGII2</a> &mdash;
                <a
